            ...
            <div className="flex flex-row justify-between min-h-[100vh]">
                <section className="sticky w-[20vw] h-full flex flex-col border-r border-primary px-[3rem] py-[2.5rem] divide-solid divide-y-[1px] divide-primary max-xl:hidden">
                    <div className="flex flex-col items-start my-">
                        <button name="/" onClick={routeChange} className="font-poppins font-medium text-xl py-[1.25rem] px-[1.2rem] w-full h-full text-start rounded-[10px] bg-transparent text-white text-opacity-90 hover:bg-primary active:text-emerald-green active:bg-lighter-primary">
                            Home
                        </button>
