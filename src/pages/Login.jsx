            ...
            <section className="bg-primary flex items-center justify-center row-span-3 xl:col-span-1 text-wrap bottom-0 top-0 left-0 right-0 px-[6rem] shadow-2xl shadow-primary p-10">
                <div className="w-full max-w-[550px]">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="font-poppins text-base text-white font-bold bg-emerald-green w-full xl:mt-8 mt-6 xl:py-6 py-4 rounded-[10px]">LOGIN</button>
                        <p className="font-poppins font-light text-xs text-emerald-green mt-4 text-center">new to VFans?
