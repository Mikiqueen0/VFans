        ...
        <div className="bg-darkest-black h-full w-full min-h-[100vh] grid grid-rows-4 xl:grid-cols-2 xl:grid-rows-1 gap-0">
            ...
            <section className="bg-primary flex items-center justify-center row-span-3 xl:col-span-1 text-wrap bottom-0 top-0 left-0 right-0 px-[8rem] shadow-2xl shadow-primary">
                <div  className="w-full max-w-[700px]">
                    <h1 className="font-poppins text-emerald-green font-bold text-[2.5rem]">
                        Login
                    </h1>
                    <p className="font-poppins text-emerald-green font-medium text-base mt-[16px]">
                    ...
                    <button className="bg-white rounded-[10px] w-full h-[75px] flex items-center justify-between mt-8 px-4">
                        ...
                        <p className="font-poppins text-[#7B7B7B] text-[1.25rem] p-6">
                            Use Google account
                        </p>
                        <div></div>
                    </button>
                    ...
                    <form action="">
                        ...
                        <button type="submit" className="font-poppins text-xl text-white font-bold bg-emerald-green w-full xl:mt-8 mt-6 xl:py-6 py-5 rounded-[10px]">LOGIN</button>
                        <p className="font-poppins font-light text-base text-emerald-green mt-4 text-center">new to VFans?
